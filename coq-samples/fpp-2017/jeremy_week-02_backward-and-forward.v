...
Qed.
  ...
  (*You get a proof close to that of Proposition baz_dual_early, since the introduction of (P1 \/ P2) as [H_P1 | H_P2] is equivalent to the step 'destruct H_P1_or_P2 as [H_P1 | H_P2]'. Hence we should be wary of splitting disjunctions when introducing variables since they might close of our options and force us to use a longer approach.*)
...
Proposition ladidah :
  ...
  intros H_P1_or_P2_or_P3_or_P4.
  intros H_P1_implies_Q H_P2_implies_Q H_P3_implies_Q H_P4_implies_Q H_Q_implies_R H_R_implies_T H_T_implies_U.
