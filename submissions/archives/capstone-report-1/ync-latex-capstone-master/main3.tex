...
\input{chapters/1-building-muscle-memory}
\input{chapters/2-writing-proofs}
\input{chapters/3-solution}
...
\begin{itemize}
	\item GNU Emacs home page <https://www.gnu.org/software/emacs/further-information.html>
	\item  Proof General home page <https://proofgeneral.github.io/>
	\item  Coq reference manual <https://coq.inria.fr/distrib/current/refman/>
	\item  Glickstein, Bob. Writing GNU Emacs Extensions. O'reilly Media, Inc., 2010.
\end{itemize}
